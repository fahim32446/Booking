...
import { useConfirmBookingMutation } from '../api/searchEndpoints';
import { IPaymentType } from '../utils/SearchPageType';
...
const BookingForm = ({ paymentIntent }: Props) => {
  ...
  useEffect(() => {
    if (isSuccess) {
      toast.success(
        'Congratulations! Your hotel reservation has been successfully confirmed.'
      );
    }
  }, [isSuccess]);
